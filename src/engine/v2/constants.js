...
// `update` is the collision routing's decision: a proposal that restates an
// effective memory of the same scope becomes a candidate revising it rather than
// a sibling. `warn` was removed: there is no state between advising and blocking
// while every write already stops at a candidate awaiting review.
